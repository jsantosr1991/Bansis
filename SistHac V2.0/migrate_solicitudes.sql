...
MODIFY COLUMN doc_cedula_cant int DEFAULT NULL,
MODIFY COLUMN doc_certificado_votacion_cant int DEFAULT NULL,
MODIFY COLUMN doc_libreta_militar_cant int DEFAULT NULL,
MODIFY COLUMN doc_certificado_iess_cant int DEFAULT NULL,
MODIFY COLUMN doc_certificado_laboral_cant int DEFAULT NULL,
MODIFY COLUMN doc_fotos_cant int DEFAULT NULL,
